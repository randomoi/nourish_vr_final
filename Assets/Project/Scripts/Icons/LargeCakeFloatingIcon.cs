...
// this class attaches icon to food by name
public class FloatingIconForCakePlate : MonoBehaviour
{
    private Camera mainCamera;
    private Canvas worldSpaceCanvas;
    private Vector3 offset = new Vector3(0f, 0.4f, 0f); //  y offset 
    ...
    void Start()
    {
        ...
        // gets plate object
        GameObject targetObject = GameObject.Find("Strawberry Cake"); // object name
        if (targetObject != null)
        {
            targetFood = targetObject.transform;
    ...
    {
        Vector3 positionOfTarget = targetFood.position + offset;
